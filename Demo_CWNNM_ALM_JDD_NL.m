    ...
    for rho = [4 4.2 4.4 4.7 4.3]
        ...
        for mu = 1.2
            ...
            for i = 1:im_num
                ...
                imname = sprintf(['C:/Users/csjunxu/Desktop/ICCV2017/24images/' Par.method '_NL_' Par.model '_Oite' num2str(Par.Iter) '_Iite' num2str(Par.maxIter) '_rho' num2str(rho) '_mu' num2str(Par.mu) '_lambda' num2str(lambda) '_' TT_im_dir(i).name]);
            ...
            name = sprintf([Par.method '_NL_Our' num2str(im_num) '_' Par.model '_Oite' num2str(Par.Iter) '_Iite' num2str(Par.maxIter) '_rho' num2str(rho) '_mu' num2str(Par.mu) '_lambda' num2str(lambda) '.mat']);
