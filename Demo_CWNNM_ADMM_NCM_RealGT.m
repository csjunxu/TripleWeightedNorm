    ...
    for rho = [0.01 0.05 0.1 0.5]
        ...
        for lambda = 4:4:16
            ...
            for i = 1:im_num
                ...
                time0 = clock;
                [im_out, Par] = CWNNM_ADMM_NCM_Denoising( Par.nim, Par.I, Par ); % WNNM denoisng function
            ...
            name = sprintf([Par.method '_NCM_CC' num2str(im_num) '_' Par.model '_Oite' num2str(Par.Iter) '_Iite' num2str(Par.maxIter) '_rho' num2str(rho) '_mu' num2str(Par.mu) '_lambda' num2str(lambda) '.mat']);
