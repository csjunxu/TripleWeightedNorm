    ...
    for mu = [1]
        ...
        for rho = [3]
            ...
            for i = 7%1:im_num
                ...
                %
                time0 = clock;
                [im_out, Par] = CWNNM_ALM_Denoising( Par.nim, Par.I, Par ); % WNNM denoisng function
            ...
            name = sprintf([Par.method '_nSig' num2str(nSig(1)) num2str(nSig(2)) num2str(nSig(3)) '_' Par.model '_Oite' num2str(Par.Iter) '_Iite' num2str(Par.maxIter) '_rho' num2str(rho) '_mu' num2str(mu) '_lambda' num2str(lambda) '.mat']);
